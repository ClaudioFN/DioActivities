...
async def test_usecases_get_should_return_not_found():
    with pytest.raises(NotFoundException) as err:
        await product_usecase.get(id=UUID('1db7eb57-1417-4b25-af41-e87beb46ec74'))

    assert (err.value.message == "Product not found with filter: 1db7eb57-1417-4b25-af41-e87beb46ec74")
...
async def test_usecases_delete_should_not_found():
    with pytest.raises(NotFoundException) as err:
        await product_usecase.delete(id=UUID('1db7eb57-1417-4b25-af41-e87beb46ec74'))
